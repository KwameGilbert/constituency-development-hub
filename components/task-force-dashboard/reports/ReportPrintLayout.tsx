    ...
    <div className="hidden print:block font-sans text-gray-900 bg-white">
      ...
      <div className="page-break flex flex-col justify-between h-[250mm]">
        ...
        <div className="my-12 text-center">
          ...
          <p className="text-xl text-gray-600">
            Period:{" "}
            {dateRange.from ? format(dateRange.from, "MMMM d, yyyy") : "N/A"} -{" "}
        ...
        <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 flex-grow mb-8">
          ...
          <p className="text-justify leading-relaxed text-gray-800 text-lg">
            This report summarizes the field verification activities conducted
            within {constituency} for the selected period. Attempts were made to
            assess a total of{" "}
            <span className="font-bold">{reports.total_issues}</span> reported
            issues across various sectors. Currently,{" "}
            <span className="font-bold">{reports.resolved_issues}</span> issues
            have been successfully resolved, resulting in an overall resolution
            efficiency of <span className="font-bold">{resolutionRate}%</span>.
          </p>
          <p className="text-justify leading-relaxed text-gray-800 text-lg mt-4">
            ...
            Active monitoring continues for outstanding items categorized under
            follow-up.
          </p>
        </div>
      ...
      <div className="page-break h-[250mm] flex flex-col">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-3 text-right">
                  {reports.total_issues}
                </td>
                <td className="border border-gray-300 p-3 text-gray-500 text-sm">
                  Valid reports received
                </td>
              </tr>
              <tr>
                <td className="border border-gray-300 p-3 font-medium">
        ...
        <div className="mb-8 break-inside-avoid">
          ...
          <table className="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              {Object.entries(reports.priority_distribution).map(
                ([key, value]) => (
                  <tr key={key}>
                    ...
                    <td className="border border-gray-300 p-3 text-right">
                      {reports.total_issues
                        ? Math.round((value / reports.total_issues) * 100)
                        : 0}
                      %
                    </td>
                  </tr>
      ...
      <div className="page-break h-[250mm] flex flex-col">
          ...
          <div className="break-inside-avoid">
            ...
            <div className="h-[250px] border border-gray-200 rounded p-4">
              <BarChart
                width={300}
                height={220}
                data={velocityData.slice(0, 7)}
              >
                {" "}
                {/* Show only last 7 days for cleanliness in print */}
            ...
            <p className="mt-2 text-sm text-gray-600 italic">
              Figure 2: Daily volume of new vs resolved assessments (Recent
              sample).
            </p>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-800 leading-relaxed">
            The current workload indicates a{" "}
            {resolutionRate > 50 ? "healthy" : "challenging"} balance between
            incoming reports and resolutions. The status distribution shows that{" "}
            {reports.status_distribution.assigned_to_task_force} issues are
            currently pending initial assessment. Resource allocation should
            prioritize high-impact areas identified in the priority breakdown.
          </p>
        </div>
      ...
      <div className="page-break h-[250mm] flex flex-col">
        ...
        <table className="w-full border-collapse border border-gray-300 text-sm mb-6">
          ...
          <tbody>
            {teamMembers.slice(0, 15).map(
              (
                member, // Limit to fit on page
              ) => (
                <tr key={member.id}>
        ...
        <div className="mb-12">
          ...
          <div className="border border-gray-300 rounded p-4 min-h-[150px] bg-white text-gray-800">
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                Ensure all field officers sync their devices daily to update
                resolution status.
              </li>
              {resolutionRate < 60 && (
                <li>
                  Urgent review of resource allocation is recommended to improve
                  resolution rate.
                </li>
              )}
