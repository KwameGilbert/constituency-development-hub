...
export function IssueDetailModal({ issue, isOpen, onClose, onAssess, onEdit }: IssueDetailModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden">
        <DialogHeader>
          <DialogTitle className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              {status && (
                <Badge className={`bg-${status.color}-100 text-${status.color}-800 border-${status.color}-200`}>
        ...
        <ScrollArea className="max-h-[calc(90vh-200px)]">
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                {issue.impactAssessment?.estimatedCost && (
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-2">Estimated Cost</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-gray-900 mb-2">Submission Date</h3>
                  <div className="flex items-center gap-2 text-gray-700">
                  ...
                  {issue.timeline.map((event, index) => (
                    <div key={event.id} className="flex gap-3">
                      ...
                      <div className="flex-1 pb-4">
                        ...
                        <p className="text-xs text-gray-500 mt-1">User ID: {event.userId}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            {issue.assessment && (
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-3">Assessment Decision</h3>
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <Badge className={issue.assessment.decision === 'approved' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
                      {issue.assessment.decision === 'approved' ? 'Approved' : 'Rejected'}
                    </Badge>
                  ...
                  {issue.assessment.comments && (
                    <p className="text-gray-700 mb-2">{issue.assessment.comments}</p>
                  )}
        ...
        <div className="flex justify-between items-center pt-4">
          <div className="flex gap-2">
            {onEdit && (
              <Button variant="outline" onClick={() => onEdit(issue.id.toString())}>
