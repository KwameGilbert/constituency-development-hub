      ...
      <CardContent className="pt-6 space-y-4">
        {issues.length > 0 ? (
              ...
              >
                ...
                <div className="flex justify-between items-start gap-4">
                  <div className="space-y-2 flex-1">
                    <h4 className="font-bold text-slate-800 text-base leading-tight group-hover:text-indigo-600 transition-colors line-clamp-1">
                      {issue.title}
                    </h4>
                  ...
                  <Link
                    ...
                    className="p-2 bg-slate-50 text-slate-400 group-hover:bg-indigo-100 group-hover:text-indigo-600 rounded-xl transition-all shadow-sm"
                  >
          ...
          <div className="text-center py-12 text-slate-400 flex flex-col items-center gap-4">
            ...
            <div>
              <h5 className="text-sm font-bold uppercase tracking-widest font-mono text-slate-400">
                Zero Intelligence Found
              </h5>
              <p className="text-[11px] font-medium text-slate-300 mt-1">
                No reports have been logged by this operative yet.
              </p>
            </div>
          </div>
        )}
