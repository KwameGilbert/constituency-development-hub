...
import { AlertTriangle, Eye, EyeOff, Save, User, MapPin, Lock, Info } from "lucide-react";
            ...
            <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                    <div className="space-y-1">
                        <CardTitle className="text-lg font-medium text-[#1e1b4b]">Agent Information</CardTitle>
                        <p className="text-sm text-muted-foreground">Update agent details and settings</p>
                    </div>
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="department" placeholder="e.g., Community Relations" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <Label>Main Community <span className="text-red-500">*</span></Label>
                                <Select>
                                    <SelectTrigger>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2 text-[#1e1b4b] font-medium pb-2 border-b">
                            ...
                            <h3>Security Information <span className="text-xs font-normal text-muted-foreground ml-2">(Leave blank to keep current password)</span></h3>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                    ...
                    <Alert className="bg-yellow-50 border-yellow-200 text-yellow-800">
                        ...
                        <AlertTitle className="text-yellow-800 font-semibold">Important Notes</AlertTitle>
