            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6 space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <FilterSelect label="Category" placeholder="All Categorys" />
                        <FilterSelect label="Status" placeholder="All Statuss" />
                        ...
                        <FilterSelect label="Main Community" placeholder="All Main Communitys" />
                        <FilterSelect label="Community" placeholder="All Communitys" />
                        <FilterSelect label="Severity" placeholder="All Severitys" />
                                    ...
                                    <Badge
                                        variant={
                                            issue.status === "Approved"
                                                ? "default" // Using default (primary) for Approved for now, or could be custom
...
function FilterSelect({ label, placeholder }: { label: string; placeholder: string }) {
    return (
        <div className="space-y-4">
            ...
            <Select>
                <SelectTrigger className="w-full border border-slate-700 rounded-md">
