      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[10px] sm:text-xs text-slate-500 font-medium">Submit a new issue on behalf of a constituent or community</p>
          </div>
        </div>
      </div>
      <Link href="/officer-dashboard/issues">
        <Button variant="outline" className="gap-2 border-slate-200 text-slate-600 font-semibold rounded-lg hover:bg-indigo-50 hover:text-indigo-700 hover:border-indigo-200 transition-all">
