  ...
  return (
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-slate-100">
      <div>
        ...
        <p className="text-sm text-slate-500">Create, edit and manage your blog content</p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
        ...
        <div className="flex gap-2">
          <Button variant="outline" className="bg-violet-50 text-violet-700 border-violet-100 hover:bg-violet-100">
            All
          </Button>
