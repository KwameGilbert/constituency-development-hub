    ...
    return (
        <div className="flex flex-col h-full bg-slate-50">
            <AdminHeader 
                ...
                actionButtons={[
                    { label: "Add New Officer", href: "/admin-dashboard/officers/new", icon: Plus, className: "bg-indigo-900 hover:bg-indigo-800 text-white" }
                ]}
            />
                                    ...
                                    <tr className="hover:bg-gray-50/50 transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="font-medium text-gray-900">Officer.Rock</span>
                                            </div>
                                        </td>
                                        ...
                                        <td className="px-6 py-4">
                                            <Badge className="bg-green-100 text-green-700 hover:bg-green-200 border-none px-3 py-1 font-normal">Active</Badge>
                                        </td>
                                        <td className="px-6 py-4 text-gray-600">
                                            Sep 28, 2025
                                        </td>
