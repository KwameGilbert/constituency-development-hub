...
export default function CommunitiesPage() {
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(
        "Failed to delete community. It may have associated suburbs or issues.",
      );
    } finally {
      setIsSubmitting(false);
    }
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              &quot;? This action cannot be undone. Communities with associated
              suburbs or issues cannot be deleted.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
