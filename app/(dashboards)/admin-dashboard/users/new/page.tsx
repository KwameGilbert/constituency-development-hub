  ...
  return (
    <div className="flex flex-col h-full bg-slate-50">
      <AdminHeader 
        ...
        actionButtons={[
          { label: "Back to Users", href: "/admin-dashboard/users", icon: ArrowLeft, className: "bg-white text-gray-700 border border-gray-200 hover:bg-gray-50 shadow-sm" }
        ]}
      />
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="role" className="text-gray-700">User Role <span className="text-red-500">*</span></Label>
                                <Select>
                                    <SelectTrigger>
                     ...
                     <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input id="password" type="password" placeholder="Enter password (min. 8 characters)" />
                                <p className="text-[10px] text-gray-400">Password must be at least 8 characters long</p>
                            </div>
                            <div className="space-y-2">
