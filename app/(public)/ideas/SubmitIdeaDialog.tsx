...
export default function SubmitIdeaDialog({ onSuccess, trigger }: SubmitIdeaDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-gray-900">Submit a Community Idea</DialogTitle>
          <DialogDescription>
            Share your suggestions for improving our constituency. Your idea will be reviewed by our team.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 py-4">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider border-t pt-4">Your Contact Info</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="submitter_name">Your Name <span className="text-red-500">*</span></Label>
                <Input
                  id="submitter_name"
                  name="submitter_name"
              ...
              <div className="space-y-2">
                <Label htmlFor="submitter_email">Email Address <span className="text-red-500">*</span></Label>
                <Input
                  id="submitter_email"
              ...
              <div className="space-y-2 md:col-span-2">
                <Label htmlFor="submitter_contact">Phone Number (Optional)</Label>
                <Input
