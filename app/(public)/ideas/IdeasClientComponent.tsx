...
import { Lightbulb, ThumbsUp, CheckCircle, Clock, AlertCircle } from 'lucide-react';
                    ...
                    <div className="mt-auto space-y-4">
                      <div className="flex items-center justify-between text-sm text-gray-500 pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-1.5 focus:text-blue-600 transition-colors">
                          <ThumbsUp className={`h-4 w-4 ${idea.votes && idea.votes > 0 ? 'text-blue-500 fill-blue-50' : ''}`} />
                          <span className="font-medium">{idea.votes || 0}</span> Votes
                        </div>
