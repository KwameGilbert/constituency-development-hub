  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 py-8 space-y-6">
        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="h-48 w-full bg-gray-100 rounded-lg animate-pulse" />
        ))}
      </div>
    );
  }
      ...
      <div className="py-12">
        ...
        {error ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-lg font-semibold text-red-700">Unable to load announcements</h3>
            <p className="text-red-600 mb-4">{error}</p>
            <Button onClick={fetchAnnouncements} variant="outline" className="border-red-200 text-red-700 hover:bg-red-50">
              Try Again
            </Button>
          </div>
              ...
              >
                <Card className="overflow-hidden hover:shadow-md transition-all duration-300 border-l-4" style={{ 
                  borderLeftColor: announcement.priority === 'urgent' ? '#ef4444' : 
                                  ...
                                  announcement.priority === 'medium' ? '#3b82f6' : '#6b7280'
                }}>
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-6">
                      <div className="flex flex-wrap items-center gap-2 mb-3">
                        ...
                        <Badge className={`${getPriorityColor(announcement.priority)} text-white border-0`}>
