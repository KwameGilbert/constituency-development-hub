            ...
            if (issueId) {
                ...
                const fetchIssue = {
                    "AssessIssue.useEffect.fetchIssue": async ()=>{
                        setLoading(true);
                        try {
                            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$issues$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["issuesService"].getIssueById(issueId);
...
//# sourceMappingURL=_3f02a125._.js.map