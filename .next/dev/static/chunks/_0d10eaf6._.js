...
"[project]/app/(dashboards)/admin-dashboard/locations/cottages/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CottagesPage() {
    ...
    const fetchSuburbs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CottagesPage.useCallback[fetchSuburbs]": async ()=>{
            try {
                ...
                if (response.success && response.data?.locations) {
                    const mappedSuburbs = response.data.locations.map({
                        "CottagesPage.useCallback[fetchSuburbs].mappedSuburbs": (loc)=>({
                                id: loc.id,
                                name: loc.name
                            })
                    }["CottagesPage.useCallback[fetchSuburbs].mappedSuburbs"]);
    ...
    }["CottagesPage.useCallback[fetchSuburbs]"], []);
    ...
    const fetchSmallerCommunities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CottagesPage.useCallback[fetchSmallerCommunities]": async ()=>{
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$locations$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["locationsService"].getLocations({
                ...
                if (response.success && response.data?.locations) {
                    const mappedCommunities = response.data.locations.map({
                        "CottagesPage.useCallback[fetchSmallerCommunities].mappedCommunities": (loc)=>({
                                id: loc.id,
                                name: loc.name,
                                parent_id: loc.parent_id
                            })
                    }["CottagesPage.useCallback[fetchSmallerCommunities].mappedCommunities"]);
    ...
    }["CottagesPage.useCallback[fetchSmallerCommunities]"], []);
    // Fetch cottages
    const fetchCottages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CottagesPage.useCallback[fetchCottages]": async ()=>{
            try {
                setLoading(true);
                const params = {
                    type: 'cottage',
                ...
                if (response.success && response.data?.locations) {
                    const mappedCottages = response.data.locations.map({
                        "CottagesPage.useCallback[fetchCottages].mappedCottages": (loc)=>({
                                id: loc.id,
                                name: loc.name,
                                parent_id: loc.parent_id,
    ...
    const handleAddCottage = async ()=>{
        if (!newCottageName.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Cottage name is required");
            return;
        }
        if (!selectedSuburb) {
        ...
        try {
            ...
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Cottage added successfully");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to add cottage");
            }
        } catch (error) {
            console.error("Failed to add cottage:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to add cottage");
        } finally{
    ...
    const handleSaveChanges = async ()=>{
        ...
        setIsSubmitting(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$locations$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["locationsService"].updateLocation(editingCottage.id, {
                name: editCottageName.trim(),
                parent_id: parentId
            });
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Cottage updated successfully");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to update cottage");
            }
        } catch (error) {
            console.error("Failed to update cottage:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update cottage");
        } finally{
            setIsSubmitting(false);
        }
    };
    ...
    const handleConfirmDelete = async ()=>{
        ...
        setIsSubmitting(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$locations$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["locationsService"].deleteLocation(editingCottage.id);
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Cottage deleted successfully");
                setIsDeleteDialogOpen(false);
                setEditingCottage(null);
                fetchCottages();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to delete cottage");
            }
        } catch (error) {
            console.error("Failed to delete cottage:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete cottage");
        } finally{
            setIsSubmitting(false);
        }
    };
...
_s(CottagesPage, "c/B8zd7xE1Iw+cw4gtp7UwJqZp8=");
_c = CottagesPage;
var _c;
__turbopack_context__.k.register(_c, "CottagesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0d10eaf6._.js.map