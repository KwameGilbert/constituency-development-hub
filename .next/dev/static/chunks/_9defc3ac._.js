...
"[project]/app/(dashboards)/admin-dashboard/locations/suburbs/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SuburbsPage() {
    ...
    const fetchCommunities = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SuburbsPage.useCallback[fetchCommunities]": async ()=>{
            try {
                ...
                if (response.success && response.data?.locations) {
                    const mappedCommunities = response.data.locations.map({
                        "SuburbsPage.useCallback[fetchCommunities].mappedCommunities": (loc)=>({
                                id: loc.id,
                                name: loc.name
                            })
                    }["SuburbsPage.useCallback[fetchCommunities].mappedCommunities"]);
    ...
    }["SuburbsPage.useCallback[fetchCommunities]"], []);
    ...
    const fetchSuburbs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SuburbsPage.useCallback[fetchSuburbs]": async ()=>{
            try {
                setLoading(true);
                const params = {
                    type: 'suburb',
                ...
                if (response.success && response.data?.locations) {
                    const mappedSuburbs = response.data.locations.map({
                        "SuburbsPage.useCallback[fetchSuburbs].mappedSuburbs": (loc)=>({
                                id: loc.id,
                                name: loc.name,
    ...
    const handleAddSuburb = async ()=>{
        if (!newSuburbName.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Suburb name is required");
            return;
        }
        if (!selectedCommunity) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Please select a community");
            return;
        }
        ...
        try {
            ...
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Suburb added successfully");
                setIsAddModalOpen(false);
                setNewSuburbName("");
                setSelectedCommunity("");
                fetchSuburbs();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to add suburb");
            }
        } catch (error) {
            console.error("Failed to add suburb:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to add suburb");
        } finally{
    ...
    const handleSaveChanges = async ()=>{
        ...
        setIsSubmitting(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$locations$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["locationsService"].updateLocation(editingSuburb.id, {
                name: editSuburbName.trim(),
                parent_id: parseInt(editCommunityId)
            });
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Suburb updated successfully");
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to update suburb");
            }
        } catch (error) {
            console.error("Failed to update suburb:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to update suburb");
        } finally{
            setIsSubmitting(false);
        }
    };
    ...
    const handleConfirmDelete = async ()=>{
        ...
        setIsSubmitting(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$locations$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["locationsService"].deleteLocation(editingSuburb.id);
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Suburb deleted successfully");
                setIsDeleteDialogOpen(false);
                setEditingSuburb(null);
                fetchSuburbs();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to delete suburb");
            }
        } catch (error) {
            console.error("Failed to delete suburb:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete suburb");
        } finally{
            setIsSubmitting(false);
        }
    };
...
_s(SuburbsPage, "viLKrXmc0/IAbmp9VKPBTiG5YBY=");
_c = SuburbsPage;
var _c;
__turbopack_context__.k.register(_c, "SuburbsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_9defc3ac._.js.map