...
"[project]/components/officer-dashboard/agents/AllAgents.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AllAgents() {
    ...
    const fetchAgents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AllAgents.useCallback[fetchAgents]": async ()=>{
            setLoading(true);
            try {
                const params = {};
                if (selectedLocation !== "all") params.location = selectedLocation;
                if (selectedVerified !== "all") params.verified = selectedVerified === "verified";
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$agent$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["agentService"].getAllAgents(params);
                if (response.success && response.data.agents) {
                    ...
                    if (searchQuery) {
                        ...
                        filteredAgents = filteredAgents.filter({
                            "AllAgents.useCallback[fetchAgents]": (agent)=>agent.user?.name?.toLowerCase().includes(query) || agent.user?.email?.toLowerCase().includes(query) || agent.agent_code?.toLowerCase().includes(query)
                        }["AllAgents.useCallback[fetchAgents]"]);
                    }
    ...
    async function handleDelete(id) {
        ...
        try {
            ...
            if (response.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(response.message || "Failed to delete agent");
            }
        } catch (error) {
...
_s(AllAgents, "jnZqTkv433vatsIfrMtbA2V/Ivc=");
_c = AllAgents;
var _c;
__turbopack_context__.k.register(_c, "AllAgents");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2dd1a9b4._.js.map