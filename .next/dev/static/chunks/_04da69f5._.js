...
"[project]/components/admin-dashboard/projects/ProjectsHeader.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/admin-dashboard/projects/ProjectsTable.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectsTable({ projects, pagination }) {
    ...
    const handleDelete = async (id)=>{
        setDeletingId(id);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$projects$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsService"].deleteProject(id);
            if (response.success) {
...
_s(ProjectsTable, "6KmiKF9sfbJThtL70/+531IRhXU=", false, function() {
    return [
...
//# sourceMappingURL=_04da69f5._.js.map