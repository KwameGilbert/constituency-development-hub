...
"[project]/app/(public)/projects/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "ProjectsPage.useEffect": ()=>{
            const fetchProjects = {
                "ProjectsPage.useEffect.fetchProjects": async ()=>{
                    try {
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$projects$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsService"].getPublicProjects({
                            limit: 100
                        }); // Initial fetch, maybe implement pagination later
                        if (response.success) {
...
_s(ProjectsPage, "4ylmyb5w5QWIKD6IgsywzSonGZI=");
_c = ProjectsPage;
var _c;
...
//# sourceMappingURL=_7f6d97db._.js.map