...
"[project]/app/(public)/blog/BlogClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BlogClient() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BlogClient.useEffect": ()=>{
            async function fetchPosts() {
                try {
                    setLoading(true);
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$blog$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["blogService"].getAllPosts(currentPage, postsPerPage);
    ...
    const filteredPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BlogClient.useMemo[filteredPosts]": ()=>{
            let filtered = posts;
            // Filter by category
            if (activeCategory !== "All") {
                filtered = filtered.filter({
                    "BlogClient.useMemo[filteredPosts]": (post)=>post.category?.toLowerCase() === activeCategory.toLowerCase()
                }["BlogClient.useMemo[filteredPosts]"]);
            }
            ...
            if (searchQuery.trim()) {
                ...
                filtered = filtered.filter({
                    "BlogClient.useMemo[filteredPosts]": (post)=>post.title?.toLowerCase().includes(query) || post.excerpt?.toLowerCase().includes(query) || post.category?.toLowerCase().includes(query)
                }["BlogClient.useMemo[filteredPosts]"]);
            }
            return filtered;
        }
                                                ...
                                                children: [
                                                    ...
                                                    post.published_at && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        children: [
                                                            ...
                                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$date$2d$fns$40$4$2e$1$2e$0$2f$node_modules$2f$date$2d$fns$2f$format$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(post.published_at), "MMM d, yyyy")
                                                        ]
                                                    }, void 0, true, {
                                                        fileName: "[project]/app/(public)/blog/BlogClient.tsx",
                                                        lineNumber: 215,
...
_s(BlogClient, "PTE1BCurDd5TbBFPnOrlYWdiCIY=");
_c = BlogClient;
var _c;
...
//# sourceMappingURL=_387ca578._.js.map