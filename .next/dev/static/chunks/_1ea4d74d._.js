...
"[project]/components/admin-dashboard/employment/JobDetailCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JobDetailCard({ job }) {
    ...
    const loadApplicants = async ()=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$employment$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["employmentService"].getJobApplicants(job.id);
            if (response.success) {
                setApplicants(response.data.applicants || []);
            }
        } catch (error) {
            console.error("Failed to load applicants:", error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Applicants feature coming soon");
        } finally{
    ...
    const handleDelete = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$employment$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["employmentService"].deleteJob(job.id);
            if (response.success) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Job deleted successfully");
                router.push("/admin-dashboard/employment");
                router.refresh();
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$sonner$40$2$2e$0$2e$7_react$2d$dom$40$19$2e$2$2e$0_react$40$19$2e$2$2e$0_$5f$react$40$19$2e$2$2e$0$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to delete job");
            }
        } catch (error) {
...
_s(JobDetailCard, "q9xIrrYzR36OipqEcI1uRAmvbkE=", false, function() {
    return [
...
_c = JobDetailCard;
var _c;
__turbopack_context__.k.register(_c, "JobDetailCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/(dashboards)/admin-dashboard/employment/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$admin$2d$dashboard$2f$employment$2f$JobDetailCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/admin-dashboard/employment/JobDetailCard.tsx [app-client] (ecmascript)");
...
function JobDetailPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JobDetailPage.useEffect": ()=>{
            const fetchJob = {
                "JobDetailPage.useEffect.fetchJob": async ()=>{
                    try {
                        setLoading(true);
                        ...
                        const foundJob = response.data.jobs.find({
                            "JobDetailPage.useEffect.fetchJob.foundJob": (j)=>j.id === parseInt(id)
                        }["JobDetailPage.useEffect.fetchJob.foundJob"]);
                        if (foundJob) {
                            setJob(foundJob);
                            setError(null);
                        } else {
            ...
            }["JobDetailPage.useEffect.fetchJob"];
            if (id) {
                fetchJob();
            }
        }
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$admin$2d$dashboard$2f$employment$2f$JobDetailCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["JobDetailCard"], {
                        job: job
                    }, void 0, false, {
                        fileName: "[project]/app/(dashboards)/admin-dashboard/employment/[id]/page.tsx",
                        lineNumber: 209,
...
_s(JobDetailPage, "eXfK4orBG0FSDrGknFieaLsI/IY=", false, function() {
    return [
...
//# sourceMappingURL=_1ea4d74d._.js.map