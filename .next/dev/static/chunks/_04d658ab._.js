...
function ProfilePage() {
    ...
    const fetchProfile = async ()=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$task$2d$force$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["taskForceService"].getProfile();
    ...
    const handleSave = async ()=>{
        try {
            setSaving(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$profile$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["profileService"].updateProfile(formData);
            if (response.success) {
...
_s(ProfilePage, "YLkprH/RNM3YT2+VfKA8ICm8MS8=");
_c = ProfilePage;
var _c;
...
//# sourceMappingURL=_04d658ab._.js.map