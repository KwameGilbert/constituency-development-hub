...
"[project]/app/(dashboards)/agents-dashboard/issues/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgentIssueDetailPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$1_$40$babel$2b$core$40$7$2e$2_27d3faa9b1a9d8cd0e1872aee1c051b9$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AgentIssueDetailPage.useEffect": ()=>{
            const fetchIssue = {
                "AgentIssueDetailPage.useEffect.fetchIssue": async ()=>{
                    try {
                        setLoading(true);
                        setError(null);
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$agent$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["agentService"].getIssueById(parseInt(id));
            ...
            }["AgentIssueDetailPage.useEffect.fetchIssue"];
            fetchIssue();
        }
    }["AgentIssueDetailPage.useEffect"], [
        id
...
_s(AgentIssueDetailPage, "M+KUwXwq1tQvkYVSacEWATEKITI=", false, function() {
    return [
...
_c = AgentIssueDetailPage;
var _c;
__turbopack_context__.k.register(_c, "AgentIssueDetailPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_bda641d0._.js.map