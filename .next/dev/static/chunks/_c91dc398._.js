...
class IdeasService {
    ...
    async getAdminIdeas(filters = {}) {
        ...
        if (filters.page) params.append("page", filters.page.toString());
        if (filters.limit) params.append("limit", filters.limit.toString());
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(`/admin/ideas?${params.toString()}`);
    }
    async getIdeaById(id) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(`/admin/ideas/${id}`);
    }
    async updateIdeaStatus(id, data) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"])(`/admin/ideas/${id}/status`, {
            method: "PUT",
        ...
        "IdeaDetailPage.useEffect": ()=>{
            const fetchIdea = {
                "IdeaDetailPage.useEffect.fetchIdea": async ()=>{
                    try {
                        setLoading(true);
                        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$ideas$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ideasService"].getIdeaById(id);
...
//# sourceMappingURL=_c91dc398._.js.map